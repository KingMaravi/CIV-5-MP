...
FROM Buildings
WHERE BuildingClass = 'BUILDINGCLASS_AGRIBUSINESS';
...
FROM Buildings a, Helper b
WHERE a.BuildingClass = 'BUILDINGCLASS_AGRIBUSINESS';
...
FROM Buildings a, Helper b
WHERE a.BuildingClass = 'BUILDINGCLASS_REFINERY';
...
SELECT
	Type, 'YIELD_CULTURE', 1
FROM Buildings
WHERE BuildingClass = 'BUILDINGCLASS_FOREIGN_BUREAU';
...
VALUES
	...
	('BUILDINGCLASS_BASTION_FORT', 'BUILDINGCLASS_CASTLE'),
	('BUILDINGCLASS_ARSENAL', 'BUILDINGCLASS_BASTION_FORT'),
	...
	('BUILDINGCLASS_PALACE_CULTURE_SCIENCE', 'BUILDINGCLASS_PUBLIC_SCHOOL'),
	('BUILDINGCLASS_INTERNATIONAL_FINANCE_CENTER', 'BUILDINGCLASS_STOCK_EXCHANGE'),
	('BUILDINGCLASS_HALL_OF_HONOR', 'BUILDINGCLASS_MILITARY_ACADEMY');
