...
WHERE BuildingClass IN (
	...
	'BUILDINGCLASS_THRONE_ROOM',
	'BUILDINGCLASS_STATE_TREASURY',
	'BUILDINGCLASS_ROYAL_GUARDHOUSE',
	'BUILDINGCLASS_PALACE_GARDEN',
	'BUILDINGCLASS_COURT_CHAPEL',
	'BUILDINGCLASS_ROYAL_ASTROLOGER',
...
WHERE Type IN (
	'BUILDING_FOREIGN_BUREAU',
	'BUILDING_PALACE_CULTURE_SCIENCE',
	'BUILDING_INTERNATIONAL_FINANCE_CENTER',
	'BUILDING_HALL_OF_HONOR'
);
...
-- Outliers
UPDATE Buildings SET NumPoliciesNeeded = 3 WHERE Type = 'BUILDING_ROMAN_FORUM';
...
VALUES
	...
	('BUILDING_IZIKO', 'TXT_KEY_THEMING_BONUS_AMPHITHEATER_NATIONAL', 4, 1),
	('BUILDING_IZIKO', 'TXT_KEY_THEMING_BONUS_AMPHITHEATER_GLOBAL', 4, 1),
	('BUILDING_GYMNASION', 'TXT_KEY_THEMING_BONUS_AMPHITHEATER_NATIONAL', 4, 1),
	...
	('BUILDING_UNIVERSITY_OF_COIMBRA', 'TXT_KEY_THEMING_BONUS_OXFORD_UNIVERSITY', 10, 6),
	('BUILDING_GLOBE_THEATER', 'TXT_KEY_THEMING_BONUS_GLOBE_THEATER', 10, 7), -- Harsh requirements

	-- Art/Artifact
	-- Both art, both from same player that is not city owner, from the same era (the only case where Salon is better than Museum)
	('BUILDING_SALON', 'TXT_KEY_THEMING_BONUS_SALON_1', 8, 4),
	-- Lowest priority
	('BUILDING_SALON', 'TXT_KEY_THEMING_BONUS_SALON_2', 4, 1),
	('BUILDING_SALON', 'TXT_KEY_THEMING_BONUS_SALON_3', 4, 1),
	('BUILDING_SALON', 'TXT_KEY_THEMING_BONUS_SALON_4', 2, 1),
	-- Both art or both artifact, both from city owner or both not from city owner, from the same era
	('BUILDING_MUSEUM', 'TXT_KEY_THEMING_BONUS_MUSEUM_1', 6, 3),
	('BUILDING_MUSEUM', 'TXT_KEY_THEMING_BONUS_MUSEUM_2', 6, 3),
	-- Missing 1 of the 3 criteria above
	('BUILDING_MUSEUM', 'TXT_KEY_THEMING_BONUS_MUSEUM_3', 5, 2),
	('BUILDING_MUSEUM', 'TXT_KEY_THEMING_BONUS_MUSEUM_4', 5, 2),
	('BUILDING_MUSEUM', 'TXT_KEY_THEMING_BONUS_MUSEUM_5', 5, 2),
	('BUILDING_MUSEUM', 'TXT_KEY_THEMING_BONUS_MUSEUM_6', 5, 2),
	('BUILDING_MUSEUM', 'TXT_KEY_THEMING_BONUS_MUSEUM_7', 5, 2),
	('BUILDING_MUSEUM', 'TXT_KEY_THEMING_BONUS_MUSEUM_8', 5, 2),
	...
	('BUILDING_INDEPENDENCE_HALL', 'TXT_KEY_THEMING_BONUS_INDEPENDENCEHALL', 8, 4),
...
VALUES
	...
	('BUILDING_GYMNASION', 'YIELD_CULTURE', 2),
	('BUILDING_IZIKO', 'YIELD_CULTURE', 2),
	('BUILDING_NALANDA', 'YIELD_CULTURE', 3),
	('BUILDING_OXFORD_UNIVERSITY', 'YIELD_SCIENCE', 4),
	('BUILDING_UNIVERSITY_OF_COIMBRA', 'YIELD_SCIENCE', 4),
	('BUILDING_GLOBE_THEATER', 'YIELD_GOLD', 10),
	('BUILDING_CHARTARIUM', 'YIELD_SCIENCE', 2),
	('BUILDING_CHARTARIUM', 'YIELD_FAITH', 6),
	-- Art/Artifact
	('BUILDING_MURANO_GLASSWORKS', 'YIELD_SCIENCE', 5),
	('BUILDING_NOTRE_DAME', 'YIELD_FAITH', 3),
	('BUILDING_NOTRE_DAME', 'YIELD_GOLDEN_AGE_POINTS', 3),
	('BUILDING_SALON', 'YIELD_CULTURE', 5),
	...
	('BUILDING_INDEPENDENCE_HALL', 'YIELD_GOLD', 3),
	('BUILDING_INDEPENDENCE_HALL', 'YIELD_CULTURE', 3),
