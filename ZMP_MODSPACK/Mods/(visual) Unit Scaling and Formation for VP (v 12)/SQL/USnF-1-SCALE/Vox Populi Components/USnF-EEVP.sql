...
--  Enlightenment Era for Vox Populi units
    ...
    --  LAND UNITS
        ...
        --  FIELD GUN [EE]
            ...
            (   'ART_DEF_UNIT_EE_FIELD_GUN',        'ART_DEF_UNIT_MEMBER_EE_FIELD_GUN',         'SUG',  'LAND', 'EEVP', 0.20,  1,          ''),
        --  LINE INFANTRY
        ...
        --  UHLAN
            ...
            (   'ART_DEF_UNIT_EE_UHLAN',            'ART_DEF_UNIT_MEMBER_EE_UHLAN',             'SUG',  'LAND', 'EEVP', 0.22,   1,          ''),
        --  HARQUEBUSIER
            (   'ART_DEF_UNIT_EE_HARQUEBUSIER',            'ART_DEF_UNIT_MEMBER_EE_HARQUEBUSIER',             'RED',  'LAND', 'EEVP', 0.085,  7,          'WedgeCavalry'),
            (   'ART_DEF_UNIT_EE_HARQUEBUSIER',            'ART_DEF_UNIT_MEMBER_EE_HARQUEBUSIER',             'RUG',  'LAND', 'EEVP', 0.17,   3,          'DefaultCavalryRUG'),
            (   'ART_DEF_UNIT_EE_HARQUEBUSIER',            'ART_DEF_UNIT_MEMBER_EE_HARQUEBUSIER',             'SUG',  'LAND', 'EEVP', 0.22,   1,          ''),
        --  CUIRASSIER
            (   'ART_DEF_UNIT_EE_CUIRASSIER',            'ART_DEF_UNIT_MEMBER_EE_CUIRASSIER',             'RED',  'LAND', 'EEVP', 0.085,  7,          'WedgeCavalry'),
            (   'ART_DEF_UNIT_EE_CUIRASSIER',            'ART_DEF_UNIT_MEMBER_EE_CUIRASSIER',             'RUG',  'LAND', 'EEVP', 0.17,   3,          'DefaultCavalryRUG'),
            (   'ART_DEF_UNIT_EE_CUIRASSIER',            'ART_DEF_UNIT_MEMBER_EE_CUIRASSIER',             'SUG',  'LAND', 'EEVP', 0.22,   1,          ''),
        --  GRENADIER
            (   'ART_DEF_UNIT_EE_GRENADIER',             'ART_DEF_UNIT_MEMBER_EE_GRENADIER',              'RED',  'LAND', 'EEVP', 0.093,  16,         'HonorableGunpowderRED'),
            (   'ART_DEF_UNIT_EE_GRENADIER',             'ART_DEF_UNIT_MEMBER_EE_GRENADIER',              'RUG',  'LAND', 'EEVP', 0.182,  3,          'HonorableGunpowderRUG'),
            (   'ART_DEF_UNIT_EE_GRENADIER',             'ART_DEF_UNIT_MEMBER_EE_GRENADIER',              'SUG',  'LAND', 'EEVP', 0.251,  1,          ''),
    ...
    --  SEA UNITS
        ...
        --	CARRACK
            ...
            (   'ART_DEF_UNIT_EE_CARRACK',          'ART_DEF_UNIT_MEMBER_EE_CARRACK',           'RUG',  'SEA',  'EEVP', 0.13,  1,          ''),
            (   'ART_DEF_UNIT_EE_CARRACK',          'ART_DEF_UNIT_MEMBER_EE_CARRACK',           'SUG',  'SEA',  'EEVP', 0.145,   1,          ''),
        --	GALLEON  (this is swapped with the Armada as it has 2 decks of guns)
            (   'ART_DEF_UNIT_EE_GALLEON',          'ART_DEF_UNIT_MEMBER_EE_GALLEON',           'RED',  'SEA',  'EEVP', 0.10,  3,          'Colomb'),
            (   'ART_DEF_UNIT_EE_GALLEON',          'ART_DEF_UNIT_MEMBER_EE_GALLEON',           'RUG',  'SEA',  'EEVP', 0.16,  1,          ''),
            (   'ART_DEF_UNIT_EE_GALLEON',          'ART_DEF_UNIT_MEMBER_EE_GALLEON',           'SUG',  'SEA',  'EEVP', 0.19,   1,          ''),
        --	SHIP OF THE LINE [EE]
