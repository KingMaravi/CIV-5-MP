...
--  Military Units
    ...
    --  ANCIENT ERA
        ...
        --	SLINGER
            ...
            (   'ART_DEF_UNIT_SLINGER',                  'ART_DEF_UNIT_MEMBER_SLINGER',                   'RED',  'LAND', 'VP',   0.09,   16,         'ArcherRED'),
            (   'ART_DEF_UNIT_SLINGER',                  'ART_DEF_UNIT_MEMBER_SLINGER',                   'RUG',  'LAND', 'VP',   0.18,   3,          'ArcherRUG'),
            (   'ART_DEF_UNIT_SLINGER',                  'ART_DEF_UNIT_MEMBER_SLINGER',                   'SUG',  'LAND', 'VP',   0.25,   1,          ''),        
	   -- GALLEY
            --New early ship unit from VP
            (   'ART_DEF_UNIT_VP_GALLEY',                  'ART_DEF_UNIT_MEMBER_VP_GALLEY',                   'SUG',  'SEA', 'VP',   0.16,   1,          ''),
	   -- LIBURNA
            --New early ship unit from VP
            (   'ART_DEF_UNIT_LIBURNA',                  'ART_DEF_UNIT_MEMBER_LIBURNA',                   'SUG',  'SEA', 'VP',   0.09,   1,          ''),
    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    --  MEDIEVAL ERA
        ------- UnitInfo ---------------------------------- UnitMemberInfo ------------------------------------ Type -- Domain  ModMod  Scale - NumMembers  Formation -----------
        --  BRAZIL'S BANDEIRANTES
            --RED: 1ST ROW - 3 Members (Wedge: Center-Left-Right)
            (   'ART_DEF_UNIT_BANDEIRANTE',                'ART_DEF_UNIT_MEMBER_BANDEIRANTE_1',                'RED',  'LAND', 'VP',   0.082,  1,          'WedgeSoldier'),
            (   'ART_DEF_UNIT_BANDEIRANTE',                'ART_DEF_UNIT_MEMBER_BANDEIRANTE_3',                'RED',  'LAND', 'VP',   0.082,  2,          'WedgeSoldier'),
            --RED: 2ND ROW - 4 Members (Wedge: InnerLeft-InnerRight-OuterLeft-OuterRight)
            (   'ART_DEF_UNIT_BANDEIRANTE',                'ART_DEF_UNIT_MEMBER_BANDEIRANTE_2',                'RED',  'LAND', 'VP',   0.082,  2,          'WedgeSoldier'),
            (   'ART_DEF_UNIT_BANDEIRANTE',                'ART_DEF_UNIT_MEMBER_BANDEIRANTE_FLAGBEARER',       'RED',  'LAND', 'VP',   0.082,  2,          'WedgeSoldier'),
            --RED: 3RD ROW - 3 Members (Wedge: Center-Left-Right)
            (   'ART_DEF_UNIT_BANDEIRANTE',                'ART_DEF_UNIT_MEMBER_BANDEIRANTE_3',                'RED',  'LAND', 'VP',   0.082,  1,          'WedgeSoldier'),
            (   'ART_DEF_UNIT_BANDEIRANTE',                'ART_DEF_UNIT_MEMBER_BANDEIRANTE_1',                'RED',  'LAND', 'VP',   0.082,  2,          'WedgeSoldier'),
            --RUG
            (   'ART_DEF_UNIT_BANDEIRANTE',                'ART_DEF_UNIT_MEMBER_BANDEIRANTE_FLAGBEARER',       'RUG',  'LAND', 'VP',   0.17,   1,          'DefaultCavalryRUG'),
            --(   'ART_DEF_UNIT_BANDEIRANTE',                'ART_DEF_UNIT_MEMBER_BANDEIRANTE_1',                'RUG',  'LAND', 'VP',   0.17,   1,          'DefaultCavalryRUG'),
            (   'ART_DEF_UNIT_BANDEIRANTE',                'ART_DEF_UNIT_MEMBER_BANDEIRANTE_2',                'RUG',  'LAND', 'VP',   0.17,   1,          'DefaultCavalryRUG'),
            (   'ART_DEF_UNIT_BANDEIRANTE',                'ART_DEF_UNIT_MEMBER_BANDEIRANTE_3',                'RUG',  'LAND', 'VP',   0.17,   1,          'DefaultCavalryRUG'),
            --SUG
            --(   'ART_DEF_UNIT_BANDEIRANTE',                'ART_DEF_UNIT_MEMBER_BANDEIRANTE_1',                'SUG',  'LAND', 'VP',   0.238,  1,          ''),
            --(   'ART_DEF_UNIT_BANDEIRANTE',                'ART_DEF_UNIT_MEMBER_BANDEIRANTE_2',                'SUG',  'LAND', 'VP',   0.238,  1,          ''),
            --(   'ART_DEF_UNIT_BANDEIRANTE',                'ART_DEF_UNIT_MEMBER_BANDEIRANTE_3',                'SUG',  'LAND', 'VP',   0.238,  1,          ''),
            (   'ART_DEF_UNIT_BANDEIRANTE',                'ART_DEF_UNIT_MEMBER_BANDEIRANTE_FLAGBEARER',       'SUG',  'LAND', 'VP',   0.238,  1,          ''),
        --  EXPLORER
            --New recon unit from VP
            --RED: 1ST ROW - 5 Members (Wedge: Center-Right-Left-Right-Left)
            (   'ART_DEF_UNIT_VP_EXPLORER',                'ART_DEF_UNIT_MEMBER_BANDEIRANTE_1',                'RED',  'LAND', 'VP',   0.082,  1,          'EarlyGreatArtist'),
            (   'ART_DEF_UNIT_VP_EXPLORER',                'ART_DEF_UNIT_MEMBER_BANDEIRANTE_2',                'RED',  'LAND', 'VP',   0.082,  1,          'EarlyGreatArtist'),
            (   'ART_DEF_UNIT_VP_EXPLORER',                'ART_DEF_UNIT_MEMBER_BANDEIRANTE_2',                'RED',  'LAND', 'VP',   0.082,  1,          'EarlyGreatArtist'),
            (   'ART_DEF_UNIT_VP_EXPLORER',                'ART_DEF_UNIT_MEMBER_BANDEIRANTE_3',                'RED',  'LAND', 'VP',   0.082,  1,          'EarlyGreatArtist'),
            (   'ART_DEF_UNIT_VP_EXPLORER',                'ART_DEF_UNIT_MEMBER_BANDEIRANTE_3',                'RED',  'LAND', 'VP',   0.082,  1,          'EarlyGreatArtist'),
            ...
            (   'ART_DEF_UNIT_VP_EXPLORER',                'ART_DEF_UNIT_MEMBER_BANDEIRANTE_3',                'RED',  'LAND', 'VP',   0.082,  1,          'EarlyGreatArtist'),
            --RUG
            (   'ART_DEF_UNIT_VP_EXPLORER',                'ART_DEF_UNIT_MEMBER_BANDEIRANTE_1',                'RUG',  'LAND', 'VP',   0.17,   1,          'EarlyGreatArtistRUG'),
            (   'ART_DEF_UNIT_VP_EXPLORER',                'ART_DEF_UNIT_MEMBER_BANDEIRANTE_2',                'RUG',  'LAND', 'VP',   0.17,   1,          'EarlyGreatArtistRUG'),
            (   'ART_DEF_UNIT_VP_EXPLORER',                'ART_DEF_UNIT_MEMBER_BANDEIRANTE_3',                'RUG',  'LAND', 'VP',   0.17,   1,          'EarlyGreatArtistRUG'),
            --SUG
            (   'ART_DEF_UNIT_VP_EXPLORER',                'ART_DEF_UNIT_MEMBER_BANDEIRANTE_1',                'SUG',  'LAND', 'VP',   0.238,  1,          ''),
            --(   'ART_DEF_UNIT_VP_EXPLORER',                'ART_DEF_UNIT_MEMBER_BANDEIRANTE_2',                'SUG',  'LAND', 'VP',   0.238,  1,          ''),
            --(   'ART_DEF_UNIT_VP_EXPLORER',                'ART_DEF_UNIT_MEMBER_BANDEIRANTE_3',                'SUG',  'LAND', 'VP',   0.238,  1,          ''),
        --  FREE COMPANY
        ...
        --  HEAVY SKIRMISHER
            ...
            (   'ART_DEF_UNIT_HEAVY_SKIRMISHER',              'ART_DEF_UNIT_MEMBER_HEAVY_SKIRMISHER',               'RED',  'LAND', 'VP',   0.085,  7,          'DefaultCavalry'),
            (   'ART_DEF_UNIT_HEAVY_SKIRMISHER',              'ART_DEF_UNIT_MEMBER_HEAVY_SKIRMISHER',               'RUG',  'LAND', 'VP',   0.17,   3,          'DefaultCavalryRUG'),
            (   'ART_DEF_UNIT_HEAVY_SKIRMISHER',              'ART_DEF_UNIT_MEMBER_HEAVY_SKIRMISHER',               'SUG',  'LAND', 'VP',   0.22,   1,          ''),
    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    --  RENAISSANCE ERA
        ------- UnitInfo ---------------------------------- UnitMemberInfo ------------------------------------ Type -- Domain  ModMod  Scale - NumMembers  Formation -----------
        --  CUIRASSIER
        ...
        --	CORVETTE (PRIVATEER)
            --Alternative to the XP_PRIVATEER
            ...
            (   'ART_DEF_UNIT_CORVETTE',                    'ART_DEF_UNIT_MEMBER_CORVETTE',                         'SUG',  'SEA',  'VP',   0.193,   1,          ''),
    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    --  INDUSTRIAL ERA
        ------- UnitInfo ---------------------------------- UnitMemberInfo ------------------------------------ Type -- Domain  ModMod  Scale - NumMembers  Formation -----------
        --  COMMANDO
    ...
    --  ATOMIC ERA
        ...
        --  MERCENARIES
            ...
            (   'ART_DEF_UNIT_MERCENARY',                    'ART_DEF_UNIT_MEMBER_GUERILLA',                     'RED',  'LAND', 'VP',   0.09,   18,         'UnFormedRED'),
            (   'ART_DEF_UNIT_MERCENARY',                    'ART_DEF_UNIT_MEMBER_GUERILLA',                     'RUG',  'LAND', 'VP',   0.18,   3,          'UnFormedRUG'),
            (   'ART_DEF_UNIT_MERCENARY',                    'ART_DEF_UNIT_MEMBER_GUERILLA',                     'SUG',  'LAND', 'VP',   0.25,   1,          ''),
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--  END OF INSERT
...
-- Move the Corvette above the water line if not replaced
UPDATE ArtDefine_UnitMemberInfos SET ZOffset = 2 WHERE (Type = 'ART_DEF_UNIT_MEMBER_CORVETTE') AND NOT EXISTS (SELECT 1 FROM Units WHERE Type = 'UNIT_EE_GALLEON');
