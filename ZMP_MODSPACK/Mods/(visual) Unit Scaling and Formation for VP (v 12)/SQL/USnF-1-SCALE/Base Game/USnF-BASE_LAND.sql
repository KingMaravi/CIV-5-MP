...
--  Land Military Units
    ...
    --  ANCIENT ERA
        ...
        --	HORSEMAN
            ...
            (   'ART_DEF_UNIT_HORSEMAN',            'ART_DEF_UNIT_MEMBER_HORSEMAN',             'SUG',  'LAND', 0.22,   1,          ''),
        --	SCOUT
    ...
    --  MEDIEVAL ERA
        ...
        --	KNIGHT
            ...
            (   'ART_DEF_UNIT_KNIGHT',              'ART_DEF_UNIT_MEMBER_KNIGHT',               'SUG',  'LAND', 0.22,   1,          ''),
        --	LONGSWORDSMAN
        ...
        --	TREBUCHET
            ...
            (   'ART_DEF_UNIT_TREBUCHET',           'ART_DEF_UNIT_MEMBER_TREBUCHET',            'SUG',  'LAND', 0.2,   1,          ''),
    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    --  RENAISSANCE ERA
        ------- UnitInfo -------------------------- UnitMemberInfo ---------------------------- Type -- Domain  Scale - NumMembers  Formation -----------------------------------
        --	CANNON
        ...
        --  LANCER
            ...
            (   'ART_DEF_UNIT_LANCER',              'ART_DEF_UNIT_MEMBER_LANCER',               'SUG',  'LAND', 0.22,   1,          ''),
        --	MUSKETMAN
    ...
    --  INDUSTRIAL ERA
        ...
        --  CAVALRY
            ...
            (   'ART_DEF_UNIT_CAVALRY',             'ART_DEF_UNIT_MEMBER_CAVALRY',              'SUG',  'LAND', 0.22,   1,          ''),
        --	RIFLEMAN
    ...
    --  MODERN ERA
        ...
        --	LANDSHIP (WW1_TANK)
            ...
            (   'ART_DEF_UNIT_WW1_TANK',            'ART_DEF_UNIT_MEMBER_WW1_TANK',             'RUG',  'LAND', 0.168,  2,          'TwoBigGunsRUG'),
            (   'ART_DEF_UNIT_WW1_TANK',            'ART_DEF_UNIT_MEMBER_WW1_TANK',             'SUG',  'LAND', 0.17,  1,          ''),
        --	MACHINE GUN
    ...
    --  ATOMIC ERA
        ...
        -- TANK
            ...
            (   'ART_DEF_UNIT_U_GERMAN_PANZER',                     'ART_DEF_UNIT_MEMBER_U_GERMAN_PANZER',                      'SUG',  'LAND', 0.195,  1,          ''),
        --  T34
            (   'ART_DEF_UNIT_TANK',                'ART_DEF_UNIT_MEMBER_TANK',                 'RED',  'LAND', 0.128,  3,          'Vehicle'),
            (   'ART_DEF_UNIT_TANK',                'ART_DEF_UNIT_MEMBER_TANK',                 'RUG',  'LAND', 0.163,  2,          'VehicleRUG'),
            (   'ART_DEF_UNIT_TANK',                'ART_DEF_UNIT_MEMBER_TANK',                 'SUG',  'LAND', 0.195,  1,          ''),
    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    --  INFORMATION ERA
        ------- UnitInfo -------------------------- UnitMemberInfo ---------------------------- Type -- Domain  Scale - NumMembers  Formation -----------------------------------
        --	BAZOOKA
        ...
        --	GIANT DEATH ROBOT
            ...
            (   'ART_DEF_UNIT_MECH',                'ART_DEF_UNIT_MEMBER_MECH',                 'SUG',  'LAND', 0.2,  1,          ''),
        --	HELICOPTER GUNSHIP
            (   'ART_DEF_UNIT_HELICOPTER_GUNSHIP',  'ART_DEF_UNIT_MEMBER_HELICOPTERGUNSHIP',    'RED',  'LAND', 0.10,   2,          'BomberWingRED'),
            (   'ART_DEF_UNIT_HELICOPTER_GUNSHIP',  'ART_DEF_UNIT_MEMBER_HELICOPTERGUNSHIP',    'RUG',  'LAND', 0.125,  1,          ''),
            (   'ART_DEF_UNIT_HELICOPTER_GUNSHIP',  'ART_DEF_UNIT_MEMBER_HELICOPTERGUNSHIP',    'SUG',  'LAND', 0.15,   1,          ''),
        --	MECHANIZED INFANTRY
        ...
        --	MODERN ARMOR
            ...
            (   'ART_DEF_UNIT_MODERN_ARMOR',        'ART_DEF_UNIT_MEMBER_MODERNARMOR',          'RUG',  'LAND', 0.17,  2,          'TwoBigGunsRUG'),
            (   'ART_DEF_UNIT_MODERN_ARMOR',        'ART_DEF_UNIT_MEMBER_MODERNARMOR',          'SUG',  'LAND', 0.19,  1,          ''),
        --	ROCKET ARTILLERY
            (   'ART_DEF_UNIT_ROCKET_ARTILLERY',    'ART_DEF_UNIT_MEMBER_ROCKETARTILLERY',      'RED',  'LAND', 0.09,   3,          'CannonLine'),
            (   'ART_DEF_UNIT_ROCKET_ARTILLERY',    'ART_DEF_UNIT_MEMBER_ROCKETARTILLERY',      'RUG',  'LAND', 0.15,   2,          'TwoBigGunsRUG'),
            (   'ART_DEF_UNIT_ROCKET_ARTILLERY',    'ART_DEF_UNIT_MEMBER_ROCKETARTILLERY',      'SUG',  'LAND', 0.15,   1,          ''),
        --  XCOM SQUAD
