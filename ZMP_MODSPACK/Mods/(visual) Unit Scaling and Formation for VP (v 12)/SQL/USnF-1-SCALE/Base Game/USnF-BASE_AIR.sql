...
--  Air Military Units
    ...
    --  FIGHTER LINE
        ...
        --  TRIPLANE (WW1_FIGHTER)
            ...
            (   'ART_DEF_UNIT_WW1_FIGHTER',     'ART_DEF_UNIT_MEMBER_WW1_FIGHTER',      'SUG',  'AIR',  0.15,  1,          ''),
        ...
        --  FIGHTER
            ...
            (   'ART_DEF_UNIT_FIGHTER',         'ART_DEF_UNIT_MEMBER_FIGHTER',          'SUG',  'AIR',  0.15,  1,          ''),
        ...
        --  JET FIGHTER
            ...
            (   'ART_DEF_UNIT_JET_FIGHTER',     'ART_DEF_UNIT_MEMBER_JETFIGHTER',       'SUG',  'AIR',  0.15,   1,          ''),
    ...
    --  BOMBER LINE
        ...
        --  BOMBER (WW1_BOMBER)
            ...
            (   'ART_DEF_UNIT_WW1_BOMBER',      'ART_DEF_UNIT_MEMBER_WW1_BOMBER',       'SUG',  'AIR',  0.08,  1,          ''),
        ...
        --  HEAVY BOMBER (BOMBER)
            ...
            (   'ART_DEF_UNIT_BOMBER',          'ART_DEF_UNIT_MEMBER_BOMBER',           'SUG',  'AIR',  0.13,    1,          ''),
            (   'ART_DEF_UNIT_BOMBER',          'ART_DEF_UNIT_MEMBER_BOMBER',           'EAW',  'AIR',  0.08,  1,          'BomberWing'),
        --  STEALTH BOMBER
            ...
            (   'ART_DEF_UNIT_STEALTH_BOMBER',  'ART_DEF_UNIT_MEMBER_STEALTHBOMBER',    'SUG',  'AIR',  0.085,   1,          ''),
    ...
    --  SINGLE-USE LINE
        ...
        --  ATOMIC BOMB
            ...
            (   'ART_DEF_UNIT_ATOMIC_BOMB',     'ART_DEF_UNIT_MEMBER_ATOMICBOMB',       'SUG',  'AIR',  0.08,  1,          ''),
