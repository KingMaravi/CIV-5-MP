...
--  Base Civilizations
    ...
    --  AMERICA
        ...
        --  B-17
            ...
            (   'ART_DEF_UNIT_U_AMERICAN_B17',                      'ART_DEF_UNIT_MEMBER_U_AMERICAN_B17',                       'SUG',  'AIR',  0.13,  1,          ''),
    ...
    --  ASSYRIA
        ...
        --  SIEGE TOWER
            ...
            (   'ART_DEF_UNIT_U_ASSYRIAN_SIEGE_TOWER',              'ART_DEF_UNIT_MEMBER_U_ASSYRIAN_SIEGE_TOWER',               'RUG',  'LAND', 0.09,   1,          'TwoBigGuns'),
            (   'ART_DEF_UNIT_U_ASSYRIAN_SIEGE_TOWER',              'ART_DEF_UNIT_MEMBER_U_ASSYRIAN_SIEGE_TOWER',               'SUG',  'LAND', 0.09,   1,          ''),
    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    --  AUSTRIA
        ------- UnitInfo ------------------------------------------ UnitMemberInfo -------------------------------------------- Type -- Domain  Scale - NumMembers  Formation ---
        --  HUSSAR
    ...
    --  EGYPT
        ...
        --  WAR CHARIOT
            ...
            (   'ART_DEF_UNIT_U_EGYPTIAN_WARCHARIOT',               'ART_DEF_UNIT_MEMBER_U_EGYPTIAN_WARCHARIOT',                'SUG',  'LAND', 0.21,   1,          ''),
    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    --  ENGLAND
        ------- UnitInfo ------------------------------------------ UnitMemberInfo -------------------------------------------- Type -- Domain  Scale - NumMembers  Formation ---
        --	LONGBOWMAN
    ...
    --  JAPAN
        ...
        --  ZERO
            ...
            (   'ART_DEF_UNIT_U_JAPANESE_ZERO',                     'ART_DEF_UNIT_MEMBER_U_JAPANESE_ZERO',                      'SUG',  'AIR',  0.15,   1,          ''),
    ...
    --  POLYNESIA
        ...
        --  WAR CANOE (POLYNESIA'S UNIQUE EMBARKATION)
            ...
            (   'ART_DEF_UNIT_U_POLYNESIAN_WAR_CANOE',              'ART_DEF_UNIT_MEMBER_U_POLYNESIAN_WAR_CANOE',               'SUG',  'SEA',  0.095,   1,          ''),
    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    --  PORTUGAL
        ------- UnitInfo ------------------------------------------ UnitMemberInfo -------------------------------------------- Type -- Domain  Scale - NumMembers  Formation ---
        --  NAU
