...
--  Enhanced Naval Warfare units
    ...
    -- ADDED UNITS
        ...
        --	FLEET DESTROYER
            (   'ART_DEF_UNIT_FLEET_DESTROYER',     'ART_DEF_UNIT_MEMBER_FLEET_DESTROYER',      'RED',  'SEA',  'ENW',  0.123,  1,          ''),
            (   'ART_DEF_UNIT_FLEET_DESTROYER',     'ART_DEF_UNIT_MEMBER_FLEET_DESTROYER',      'RUG',  'SEA',  'ENW',  0.135,  1,          ''),
            (   'ART_DEF_UNIT_FLEET_DESTROYER',     'ART_DEF_UNIT_MEMBER_FLEET_DESTROYER',      'SUG',  'SEA',  'ENW',  0.175,  1,          ''),
        --	MISSILE DESTROYER
            (   'ART_DEF_UNIT_SENSOR_COMBAT_SHIP',   'ART_DEF_UNIT_MEMBER_SENSOR_COMBAT_SHIP',    'RED',  'SEA',  'ENW',  0.117,  1,          ''),
            (   'ART_DEF_UNIT_SENSOR_COMBAT_SHIP',   'ART_DEF_UNIT_MEMBER_SENSOR_COMBAT_SHIP',    'RUG',  'SEA',  'ENW',  0.145,  1,          ''),
            (   'ART_DEF_UNIT_SENSOR_COMBAT_SHIP',   'ART_DEF_UNIT_MEMBER_SENSOR_COMBAT_SHIP',    'SUG',  'SEA',  'ENW',  0.165,  1,          ''),
        --	ADVANCED DESTROYER
