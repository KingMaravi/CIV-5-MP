...
for k, v, w in ([[
	...
	NOTIFICATION_SPY_YOU_STAGE_COUP_SUCCESS		Spy
	NOTIFICATION_SPY_YOU_STAGE_COUP_FAILURE		SpyWasKilled
	...
	NOTIFICATION_CULTURE_VICTORY_SOMEONE_INFLUENTIAL	CultureVictoryPositive
	NOTIFICATION_CULTURE_VICTORY_WITHIN_TWO			CultureVictoryNegative
	NOTIFICATION_CULTURE_VICTORY_WITHIN_TWO_ACTIVE_PLAYER	CultureVictoryPositive
	NOTIFICATION_CULTURE_VICTORY_WITHIN_ONE			CultureVictoryNegative
	NOTIFICATION_CULTURE_VICTORY_WITHIN_ONE_ACTIVE_PLAYER	CultureVictoryPositive
	NOTIFICATION_CULTURE_VICTORY_NO_LONGER_INFLUENTIAL	CultureVictoryNegative
	...
	NOTIFICATION_ESPIONAGE_OUTCOME		EspionageOutcome
