...
INSERT OR REPLACE INTO Improvement_ResourceTypes -- this is just to prevent the bug where the resource graphic shows up when you put a GPTI on the tile
		(ResourceType, ImprovementType)
...
----------------------------------------------------------------------------------------------------------------------------
INSERT OR REPLACE INTO Corporation_ResourceMonopolyOrs
		(CorporationType, ResourceType)
VALUES	-- City state luxuries
		('CORPORATION_TWOKAY_FOODS', 'RESOURCE_BEER'),
		('CORPORATION_CENTAURUS_EXTRACTORS', 'RESOURCE_BIRDS_NEST'),
...
----------------------------------------------------------------------------------------------------------------------------
INSERT OR REPLACE INTO Corporation_ResourceYieldChanges
