...
local g_ProdQueueIM, g_SpecialBuildingsIM, g_GreatWorkIM, g_WondersIM, g_BuildingsIM, g_GreatPeopleIM, g_SlackerIM, g_UnitSelectIM, g_GPUnitSelectIM, g_ReligiousUnitSelectIM, g_MilitaryUnitSelectIM, g_LandUnitSelectIM, g_SeaUnitSelectIM, g_AirUnitSelectIM, g_BuildingSelectIM, g_ProjectSelectIM, g_NationalWonderSelectIM, g_WonderSelectIM, g_ProcessSelectIM, g_FocusSelectIM
local g_slots = table()
local g_works = table()
	...
	if isSelectionList then
		...
		if not g_isDebugMode then
			...
			for item in GameInfo.Units() do
				...
				local isReligiousUnit
				if gk_mode then
					isReligiousUnit = item.ReligiousStrength > 0
				end
